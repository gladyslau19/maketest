...
namespace{
    ...
    bitboard::bitboard(/**MicroBit &_uBit,**/ BLE &_ble, KeyboardService* _kbdServicePtr: /**uBit(_uBit),**/ ble(_ble), kbdServicePtr(_kbdServicePtr){
        Buffer = 0; //might change data type to allow for multi keypress
        DEVICE_NAME = "bit:board";
    ...
    void bitboard::send_keypress(uint8_t key_code){
        inputReportData[0] = 0;
        inputReportData[2] = key_code;
